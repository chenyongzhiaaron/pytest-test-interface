...
class UpdateUserInfo(unittest.TestCase):
    ...
    @parameterized.expand([
        ('获取最新口子列表成功', "POST", "422201198811260900", "18888888888", "false", "request1565596327350", "赵冰冰",
         "c50e2b0f1b16429da5df10e601790ak3,", "2.6.0", "15", "867910035562539", "1", "1003", "sinaif",
         "ef70fb3178dccde19df9295a68aca0a3", "qsj"),
    ])
    def test_update_user_info(self, case, method, idcard, mobile, json, callbackName, username, tags, ver, verno,
